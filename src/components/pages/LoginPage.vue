...
function typeWriter() {
  if (i < tutorialMessage.length) {
    document.getElementById("tutorial").innerHTML += tutorialMessage.charAt(i);
    i++;
    setTimeout(typeWriter, speed);
  } else {
    document.getElementById("source").innerHTML += sourceCode.charAt(j);
    j++;
    setTimeout(typeWriter, speed);
  }
}
